...
Реализованы интеграционные тесты для всех возможных типов страницв в приложении:
...
* страницы с деревом файлов из коммита;
* страницы с отображением содержимого файлов из коммита.  
