...
Реализованы интеграционные тесты для главной страницы, страницы ветки, страницы с деревом файлов. Последовательность и отдельные пункты отличаются от указанных в ТЗ, но сохраняют общую логику. На лекции упоминали, что если описанные в ДЗ тесты не подходят под наш вариант приложения, то можно их изменить, сохранив основную идею.
